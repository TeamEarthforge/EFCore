...
public class EasingUtils {
    public static float ease(float t, CameraAnimationFrame.InterpolationType type) {
        switch (type) {
            case LINEAR:
                return t;
            case EASE_IN_QUAD:
            ...
            case EASE_IN_BOUNCE:
                return 1 - ease(1 - t, CameraAnimationFrame.InterpolationType.EASE_OUT_BOUNCE);
            ...
            case EASE_IN_OUT_BOUNCE:
                if (t < 0.5) {
                    return 0.5f * ease(2 * t, CameraAnimationFrame.InterpolationType.EASE_IN_BOUNCE);
                } else {
                    return 0.5f * ease(2 * t - 1, CameraAnimationFrame.InterpolationType.EASE_OUT_BOUNCE) + 0.5f;
                }
